...
I2C_LOCATION_T  DevicesI2C[] =
    {// Cluster   Slice    Port    DtoA   AtoD    Dig     Name
        ...
        { 0,        4,     0x60,     4,    0,      0, "D/A 92  - 95"  }, // Filter #0 & #1
        { 0,        4,     0x38,     0,    0,      8, "Dig 96  - 103" },
        { 0,        1,     0x60,     4,    0,      0, "D/A 104 - 107" }, // Osc #2
        { 0,        1,     0x61,     4,    0,      0, "D/A 108 - 111" },
        { 0,        1,     0x62,     4,    0,      0, "D/A 112 - 115" }, // Osc #3
        { 0,        1,     0x63,     4,    0,      0, "D/A 116 - 119" },
        { 0,        5,     0x60,     4,    0,      0, "D/A 120 - 123" }, // Filter #2 & #3
        { 0,        5,     0x38,     0,    0,      8, "Dig 124 - 131" },
        { 0,        2,     0x60,     4,    0,      0, "D/A 132 - 135" }, // Osc #4
        { 0,        2,     0x61,     4,    0,      0, "D/A 136 - 139" },
        { 0,        2,     0x62,     4,    0,      0, "D/A 140 - 143" }, // Osc #5
        { 0,        2,     0x63,     4,    0,      0, "D/A 144 - 147" },
        { 0,        6,     0x60,     4,    0,      0, "D/A 148 - 151" }, // Filter #4 & #5
        { 0,        6,     0x38,     0,    0,      8, "Dig 152 - 159" },
        { 0,        3,     0x60,     4,    0,      0, "D/A 160 - 163" }, // Osc #6
        { 0,        3,     0x61,     4,    0,      0, "D/A 164 - 167" },
        { 0,        3,     0x62,     4,    0,      0, "D/A 168 - 171" }, // Osc #7
        { 0,        3,     0x63,     4,    0,      0, "D/A 172 - 175" },
        { 0,        7,     0x60,     4,    0,      0, "D/A 176 - 179" }, // Filter #6 & #7
        { 0,        7,     0x38,     0,    0,      8, "Dig 180 - 187" },
        { 7,        0,     0x60,     4,    0,      0, "D/A 188 - 191" }, // Unallocated D/A
        { 7,        1,     0x60,     4,    0,      0, "D/A 192 - 195" },
        { 7,        2,     0x60,     4,    0,      0, "D/A 196 - 199" },
        { 7,        3,     0x60,     4,    0,      0, "D/A 200 - 203" },
        { 7,        4,     0x60,     4,    0,      0, "D/A 204 - 207" },
        { 1,        0,     0x20,     0,    0,     16, "Dig 208 - 223" },
